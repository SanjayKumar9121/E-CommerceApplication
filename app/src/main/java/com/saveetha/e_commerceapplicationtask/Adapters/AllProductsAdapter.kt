...
class AllProductsAdapter(var itemList: List<AllProductsList>):RecyclerView.Adapter<AllProductsAdapter.Viewholder>() {
    ...
    fun updateProducts(newProducts: List<AllProductsList>) {
